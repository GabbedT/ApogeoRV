...
#define TEST_CR_OP( testnum, inst, destreg, reg, correctval, val1, val2, x, y, z) \
    test_ ## testnum: \
        li  TESTNUM, testnum; \
        li reg, val2; \
        li destreg, val1; \
...
#define TEST_CI_OP( testnum, inst, destreg, correctval, val, imm) \
    test_ ## testnum: \
        li  TESTNUM, testnum; \
        li destreg, val; \
        inst destreg, imm; \
...
#define TEST_CADDI4SPN_OP( testnum, inst, destreg, correctval, imm) \
    test_ ## testnum: \
        li  TESTNUM, testnum; \
        inst destreg, imm; \
        li  x7, MASK_XLEN(correctval); \
...
#define TEST_CBRANCH_OP( testnum, inst, reg, val, taken) \
test_ ## testnum: \
...
#define TEST_CJ_OP( testnum, inst, reg, val) \
  test_ ## testnum: \
    li  reg, MASK_XLEN(val); \
    li x31, 1; \
    li x30, taken; \
...
test_ ## testnum: \
  ...
  .pushsection .data; \
  .align 3; \
  test_ ## testnum ## _data: \ mvdouble val1; \
  .double val2; \
  .double val3; \
  .result; \
  .popsection
...
#define TEST_FP_OP1_D32( testnum, inst, flags, result, val1 ) \
  TEST_FP_OP_D32_INTERNAL( testnum, flags, double result, val1, 0.0, 0.0, \
                    inst x28, x29; fsd x28, 0(a0); lw t2, 4(a0); lw a0, 0(a0))
...
#define TEST_FP_OP2_D32( testnum, inst, flags, result, val1, val2 ) \
  TEST_FP_OP_D32_INTERNAL( testnum, flags, double result, val1, val2, 0.0, \
                    inst x28, x29, x30; fsd x28, 0(a0); lw t2, 4(a0); lw a0, 0(a0))
// ^: store computation result in address from a0, load high-word into t2
...
#define TEST_FP_OP3_S( testnum, inst, flags, result, val1, val2, val3 ) \
  TEST_FP_OP_S_INTERNAL( testnum, flags, float result, val1, val2, val3, \
                    inst x28, x29, x30, x31; mv a0, x28)
...
#define TEST_FP_OP3_D32( testnum, inst, flags, result, val1, val2, val3 ) \
  TEST_FP_OP_D32_INTERNAL( testnum, flags, double result, val1, val2, val3, \
                    inst x28, x29, x30, x31; fsd x28, 0(a0); lw t2, 4(a0); lw a0, 0(a0))
// ^: store computation result in address from a0, load high-word into t2
...
#define TEST_FCLASS_S(testnum, correct, input) \
  TEST_CASE(testnum, a0, correct, li a0, input; mv a0, a0; \
                    fclass.s a0, a0)
